...
var app = (function() {
    ...
    function initUniforms() {
        ...
        // Projection Matrix.
        prog.pToonUniform = gl.getUniformLocation(prog, "uToon");
    ...
    function update(t, dt) {
        ...
        illumination.light[0].position = [Math.sin(light_time) * 3, 1.0, Math.cos(light_time) * 3];
        illumination.light[1].position = [Math.sin(-light_time/2) * 5, 1.0, Math.cos(-light_time/2) * 5];
    }
    ...
    function render(timestamp) {
        var dt = (timestamp - last_timestamp) / 1000; // In seconds
        var t = timestamp / 1000; // In seconds
    ...
    function draw(model) {
        ...
        gl.uniform1i(prog.pToonUniform, toon_shade);
